...
#define _MAXNUMBER 100 /* megistos arithmos stoixeiou */
...
int main(int argc,char *argv[]){
	...
	if(myid == 0){
		...
		thesi=(int*)malloc(numprocs*sizeof(int));
		if(thesi==NULL){
			printf("\nAdunamia desmeushs mnhmhs!\nTelos programmatos!\n");
			exit(1);
		}
	...
	Aw=(int*)malloc(part*sizeof(int));	             // Desmeush mnhmhs megethous part gia ton pinaka Aw  
